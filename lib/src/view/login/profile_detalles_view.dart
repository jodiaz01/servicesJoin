...
class DetailsPefilView extends StatelessWidget {
   DetailsPefilView({super.key, required this.userProvider});
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (dynamic entero) =>
                      userProvider.userDatails.esperiencia = int.parse(entero),
                      validator: (value) {
                        if (value == '')
                ...
                Container(
                  ...
                  child: TextFormField(
                    keyboardType: TextInputType.text,
                    onChanged: (value) =>
                    userProvider.userDatails.tiempo = value,
                    validator: (value) {
                      if (value == '')
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (value) =>
                    userProvider.userDatails.contacto = value,
                    validator: (value) {
                      if (value == '')
                ...
                Container(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          child: Text('N/A'), value: 'N'),
                    ],
                    onChanged: (String? value) =>
                    userProvider.userDatails.sexo = value!,
                    validator: (value) {
                      if (value == '' || value == null)
                        return 'Debe  Elegir Sexo';
